...
#===================================================================
def save_image_if_not_exists(file_name, image):
    """
...
save_image_if_not_exists('original_image.png', img)
save_image_if_not_exists('thresholded_image.png', binary_labels)
save_image_if_not_exists('filtered_components.png', filtered_labels)
save_image_if_not_exists('final_result.png', color_img)
